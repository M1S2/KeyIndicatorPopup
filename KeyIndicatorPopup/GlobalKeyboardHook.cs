...
namespace KeyIndicatorPopup
{
    ...
    class GlobalKeyboardHookEventArgs : HandledEventArgs
    {
        ...
        public GlobalKeyboardHookEventArgs(GlobalKeyboardHook.LowLevelKeyboardInputEvent keyboardData, GlobalKeyboardHook.KeyboardState keyboardState)
        {
            ...
            if((KeyboardData.VirtualCode >= GlobalKeyboardHook.VK_0 && KeyboardData.VirtualCode <= GlobalKeyboardHook.VK_9) || (KeyboardData.VirtualCode >= GlobalKeyboardHook.VK_NUM0 && KeyboardData.VirtualCode <= GlobalKeyboardHook.VK_NUM9))
            {
                KeyType = KeyTypes.Numeric;
            }
            else if(KeyboardData.VirtualCode >= GlobalKeyboardHook.VK_A && KeyboardData.VirtualCode <= GlobalKeyboardHook.VK_Z)
            {
